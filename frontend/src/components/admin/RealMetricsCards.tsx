...
interface RealMetricsCardsProps {
  initialData?: DashboardMetrics;
}

export default function RealMetricsCards({ initialData }: RealMetricsCardsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {lastUpdated && (
        ...
        >
          Last updated: {lastUpdated.toLocaleTimeString()} • Auto-refreshing every 10 seconds
        </motion.div>
      )}
    </div>
  );
